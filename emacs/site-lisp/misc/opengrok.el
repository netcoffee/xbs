...
(defcustom opengrok-jar "/work/tools/opengrok-0.11.1-src/dist/opengrok.jar"
  "The location of file `opengrok.jar' containing the OpenGrok byte code."
  :group 'opengrok
  :type 'directory)

(defcustom opengrok-ctags-command "/usr/bin/ctags"
  "Directory in which Exuberant Ctags lives."
  :group 'opengrok
  :type 'directory)

(defcustom opengrok-ctags-options "/etc/ctags.conf"
